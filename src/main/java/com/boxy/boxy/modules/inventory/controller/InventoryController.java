...
public class InventoryController {
    ...
    public ResponseEntity<ApiResponse<List<StockLevelDto>>> getStockLevels(@PathVariable String warehouseId) {
    ...
    @PreAuthorize("hasAuthority('inventory:transfer') or hasAuthority('ROLE_ADMIN')")
    ...
    public ResponseEntity<ApiResponse<StockTransferDto>> dispatchTransfer(@PathVariable String id) {
    ...
    public ResponseEntity<ApiResponse<StockTransferDto>> receiveTransfer(@PathVariable String id) {
